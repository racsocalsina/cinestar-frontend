...
@Component( {
    selector: 'app-modal-desktop-chocolateria-confirmation',
    templateUrl: './modal-desktop-chocolateria-confirmation.component.html',
    styleUrls: ['./modal-desktop-chocolateria-confirmation.component.scss']
} )
export class ModalDesktopChocolateriaConfirmationComponent implements OnInit {
