...
@Component( {
    selector: 'app-modal-desktop-purchase-confirmation',
    templateUrl: './modal-desktop-purchase-confirmation.component.html',
    styleUrls: ['./modal-desktop-purchase-confirmation.component.scss']
} )
export class ModalDesktopPurchaseConfirmationComponent implements OnInit {
